...
(function (Manufactures) {
    Manufactures["airBus"] = "Airbus";
    Manufactures["boeing"] = "Boeing";
})(Manufactures || (Manufactures = {}));
function AirplaneDecorator(manufacture) {
    return (target) => {
...
let Aircraft = (() => {
    let _classDecorators = [AirplaneDecorator(Manufactures.airBus)];
